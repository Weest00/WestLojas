...
public class ClassGeter {
    ...
    public void setupListeners() {
        try {
            ImmutableSet<ClassPath.ClassInfo> infoList = ClassPath.from(Main.class.getClassLoader()).getTopLevelClassesRecursive("br.com.west.lojas.listeners");
    ...
    public void setupCommands() {
        try {
            ImmutableSet<ClassPath.ClassInfo> infoList = ClassPath.from(Main.class.getClassLoader()).getTopLevelClassesRecursive("br.com.west.lojas.commands");
            for (ClassPath.ClassInfo info : infoList) {
                Class<?> cls = Class.forName(info.getName());
